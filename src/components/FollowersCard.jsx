...
function FollowersCard(props) {
  const { followers, handleFollow, handleUnfollow } = props
  return (
      ...
      <div key={key} className='feed-card' >
        <div className='feed-card-title'>
          ...
          <div className='feed-card-title-right'>
            {false ? <button id='follow-btn' name={follower.id} onClick={handleFollow}>Follow</button> : <button id='unfollow-btn' name={follower.id} onClick={handleUnfollow}>Unfollow</button>}
          </div>
        </div>
